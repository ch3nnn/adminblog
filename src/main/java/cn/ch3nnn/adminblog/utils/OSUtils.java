...
public class OSUtils {
    ...
    public static HashMap<String, Object> memory() throws SigarException {
        Sigar sigar = new Sigar();
        Mem mem = sigar.getMem();
        HashMap<String, Object> memoryHashMap = new HashMap<>(10);
        memoryHashMap.put("当前内存使用率", (float) mem.getUsed() / mem.getTotal() * 100);
